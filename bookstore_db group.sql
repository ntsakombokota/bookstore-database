...
INSERT INTO `author` VALUES (1,'John','Green'),(2,'J.K.','Rowling'),(3,'George','Martin');
...
INSERT INTO `book` VALUES (1,'The Fault in Our Stars','9780142424179',2012,200.00,1,3),(2,'A Game of Thrones','9780553103540',1996,350.00,1,2),(3,'Harry Potter and the Philosopher\'s Stone','9780747532699',1997,300.00,1,3);
...
INSERT INTO `book_author` VALUES (1,1),(3,2),(2,3);
...
INSERT INTO `book_language` VALUES (1,'English'),(2,'French'),(3,'Spanish'),(4,'English'),(5,'French'),(6,'Spanish');
...
INSERT INTO `customer` VALUES (1,'Ntsako','Mbokota','ntsako@example.com','0123456789'),(2,'Jane','Doe','jane.doe@example.com','0987654321');
...
INSERT INTO `publisher` VALUES (1,'Pearson Education','https://www.pearson.com'),(2,'O’Reilly Media','https://www.oreilly.com'),(3,'Penguin Books','https://www.penguin.com'),(4,'Pearson Education','https://www.pearson.com'),(5,'O’Reilly Media','https://www.oreilly.com'),(6,'Penguin Books','https://www.penguin.com');
...
-- Dump completed on 2025-04-12 20:30:21
